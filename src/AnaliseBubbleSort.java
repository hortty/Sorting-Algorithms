...
public class AnaliseBubbleSort {
    public static void main(String[] args) {
        ...
        try {
            String nomeClasse = AnaliseBubbleSort.class.getSimpleName();
            ...
            for (int tamanho : tamanhos) {
                ...
                for (int execucao = 0; execucao < numExecucoes; execucao++) {
                    ...
                    int[] resultados = bubbleSort(Arrays.copyOf(vetor, vetor.length)); // Crie uma cópia do vetor para manter o original inalterado
    ...
    public static int[] bubbleSort(int[] vetores) {
